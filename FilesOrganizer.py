...
from it_systems_adm.files_actions import FilesOrganization
from it_systems_adm.logger import Logger
from it_systems_adm.notifications import EmailNotifications
from it_systems_adm.notifications import MailBodies
...
def main():
    ...
    cli = Cli(__version__)
    CONFIG_FILE = cli.get_args_from_cli()
    try:
